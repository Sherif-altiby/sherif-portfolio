      ...
      <div className="bg-hero-main bg-cover h-[700px] md:h-[550px] pt-4">
        <div className="container ml-auto mr-auto px-3">
            <div className="flex flex-row items-start justify-between py-3" data-aos="fade-right" data-aos-duration="1500" >
                ...
                <div className="hidden md:block" ><a href="https://drive.google.com/file/d/1CjE2qJx20UVd-ZDu4AQWlfa2X2kAvT-w/view?usp=sharing" target="_blank" className="bg-btnColor no-underline cursor-pointer text-light py-3 px-5 text-xl rounded-md hover:bg-[#126ffa]" > Resume </a></div>
            </div>
